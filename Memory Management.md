...
- transient
instance block gets executed first then constructor block show this example, first is static block,  create 2 -3 objects and show static executes once when class is loaded
default is not access modifier
